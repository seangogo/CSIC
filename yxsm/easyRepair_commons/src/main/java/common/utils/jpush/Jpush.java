...
public class Jpush {
    ...
    private static Integer MAX_RETRY_TIMES = 3;
    private JPushClient jpushClient = null;
    private static Map<String, String> extras = new HashMap<String, String>();

    public Jpush(String appKey, String masterSecret) {
        this.jpushClient = new JPushClient(masterSecret, appKey, MAX_RETRY_TIMES);
        extras.put("time", DateTime.now().toString("yyyy-MM-dd HH:mm:ss"));
    }
