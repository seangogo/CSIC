...
! function(a) {
	...
	function e(a, b, c) {
		...
		a.cells({
			selected: !0
		}).any() || c ? (e = g(c.column, b.column), f = h(c.row, b.row)) : (e = g(0, b.column), f = h(0, b.row)), d = a.cells(f, e).flatten(), a.cells(b, {
			selected: !0
		}).any() ? a.cells(d).deselect() : a.cells(d).select()
	}
	...
	function i(b) {
		...
		if(c._select.info && c.aanFeatures.i) {
			...
			e("row", b.rows({
				selected: !0
			}).flatten().length), e("column", b.columns({
				selected: !0
			}).flatten().length), e("cell", b.cells({
				selected: !0
			}).flatten().length), a.each(c.aanFeatures.i, function(b, c) {
				c = a(c);
	...
	function k(b, c, d, e) {
		...
		b[c](d, {
			selected: !0
		}).any() ? (f.splice(a.inArray(d, f), 1), b[c + "s"](f).deselect()) : b[c + "s"](f).select()
	}
