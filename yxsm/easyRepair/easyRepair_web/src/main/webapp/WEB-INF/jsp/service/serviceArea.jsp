...
<script src="${ctx}/static/js/tree.min.js"></script>
<body class="no-skin">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body no-padding">
                                        <form action="/service/saveServiceArea" id="updateUserForm" method="post">
                        ...
                        <div id="modal-form"  class="modal fade" tabindex="-1"  role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" id="serviceAreaForm" method="post" action="/service/saveServiceArea" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" id="iconUrl" name="iconUrl"
                                                           class="form-control" placeholder="请输入图标链接" data-rule="required;url" />
                                                </div>
                                            </div>
        ...
        fn: {
            init: function () {
                ...
                /*$('#treeResources').ace_tree({
                    dataSource: serviceArea.fn.initiateTree(),
                    multiSelect: true,
                    cacheItems: true,
                ...
                $("#create").click(function () {
                    ...
                    $('#save').show();
                    serviceArea.fn.showModal("新建工程师类型");
                ...
                $("#all-delete").click(function () {
                    ...
                    serviceArea.fn.deleteRow(checkBox, ids);
                })
            },
            dataTableInit: function () {
                serviceArea.v.dTable = $dh.dataTable($('#dataTables'), {
                    "processing": true,
                    "serverSide": true,
                    "ordering": false,
                    "searching": false,
                    "ajax": {
                        "url": "service/serviceAreaPage",
                        "type": "POST"
                    },
                    "columns": [
                        {"data": "","defaultContent": ""},
                    ...
                    "rowCallback": function (row, data) {
                        $('td', row).last().find(".delete").click(function () {
                            ...
                            serviceArea.fn.deleteRow(checkbox, [data.id]);
                        })

                        $('td', row).last().find(".edit").click(function () {
                            serviceArea.fn.edit(data.id);
                        });
                        $('td', row).last().find(".showInfo").click(function () {
                            ...
                            for(var i=0;i<selects.length;i++){
                                selects.eq(i).attr('disabled','disabled');
                            }
                            $('#save').hide();
            ...
            deleteRow: function (checkBox, ids) {
                if (ids.length > 0) {
                    ...
                    $dh.optNotify(function () {
                        $dh.ajax("/service/deleteServiceArea", {ids: JSON.stringify(ids)}, function (result) {
                            if (result.status == "0") {
            ...
            edit: function (id) {
                ...
                serviceArea.fn.showModal("修改用户");
                var items = serviceArea.v.list;
