    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="pwdForm" method="post" action="member/modifyPwd" class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="oldPwd" class="col-sm-3 control-label">旧密码:</label>
                        <div class="col-sm-5">
                            <input type="password" class="form-control" id="oldPwd" name="oldPwd" data-rule="required;length[6~];remote[member/check/oldPwd]" placeholder="请输入旧密码">
                        </div>
                    </div>
                    <div class="form-group">
