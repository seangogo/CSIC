...
public class TaskController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		model.addAttribute("index", "task/taskList");
		model.addAttribute("tableType", resourceService.findTabeType("task/taskList"));
	...
	public String createForm(Model model) {
		...
		model.addAttribute("index", "task/create");
	...
	public String create(@Valid Task newTask, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("index", "task/taskList");
