            ...
            for ( ; i < imgNum; ) {
                ...
                for ( var j = 0; j < imgColNum; j++, i++ ) {
                    ...
                    if ( faceImage ) {
                        ...
                        textHTML.push( '<span>' );
                        textHTML.push( '<img  style="background-position:left ' + offset + 'px;" title="' + infor + '" src="' + emotion.SmileyPath + (editor.options.emotionLocalization ? '0.gif" width="' : 'default/0.gif" width="') + iWidth + '" height="' + iHeight + '" />' );
                        textHTML.push( '</span>' );
                    } else {
